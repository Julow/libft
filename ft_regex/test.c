...
/*   Updated: 2016/01/04 01:02:32 by juloo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char **argv)
{
	...
	if (argc <= 1)
	{
		...
		test_test("?#{REG}(\\??\?(#?\?'#'{?-*&.})?*&[!i=-]?&2[*?+]|&2(?*d?\?(,?*d))?\?&3(&?*d)?&4[.aludnswb$^]|&4(\"?-*.\")|&4('?-*.')|&4([?-*.])|&4((?-*.\\))|&4({?-*.}))", "?^?w");
		test_test("?#{REG}(\\??\?(#?\?'#'{?-*&.})?*&[!i=-]?&2[*?+]|&2(?*d?\?(,?*d))?\?&3(&?*d)?&4[.aludnswb$^]|&4(\"?-*.\")|&4('?-*.')|&4([?-*.])|&4((?-*.\\))|&4({?-*.}))", "?##{FLOAT}(?+d?\?(.?*d))<?{FLOAT}>");
		test_test("?#{REG}(\\??\?(#?\?'#'{?-*&.})?*&[!i=-]?&2[*?+]|&2(?*d?\?(,?*d))?\?&3(&?*d)?&4[.aludnswb$^]|&4(\"?-*.\")|&4('?-*.')|&4([?-*.])|&4((?-*.\\))|&4({?-*.}))", "?#{FLOAT}!=-i1,2&5d");
		test_test("?#{REG}(\\??\?(#?\?'#'{?-*&.})?*&[!i=-]?&2[*?+]|&2(?*d?\?(,?*d))?\?&3(&?*d)?&4[.aludnswb$^]|&4(\"?-*.\")|&4('?-*.')|&4([?-*.])|&4((?-*.\\))|&4({?-*.}))", "?#{FLOAT}!=-i*&d");
		...
		test_test("?-*&d?*&w?+&a?+&d", "42lol42");
		test_test("?-*&d?-*&w?+&a?+&d", "42lol42");
		test_test("?+&0'a'b?{&0}", "aaabaaa");
		test_test("?+&0'a'b?{&0}", "aabaaaa");
		test_test("?+&0'a'b?{&0}", "aaaaba");
		return (0);
	}
